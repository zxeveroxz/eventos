            ...
            <div class="card">
                <div class="card-body">
                    <table id="table" class="table-striped" data-toggle="table"
                        data-url="<?= base_url("$ORG/eventos_aperturas/get") ?>" data-height="450">
                        <thead>
                            <tr>
...
window.operateEvents = {
    'click .editar': function(e, value, row, index) {
        ...
        $('#modalForm')
            ...
            .modal('show')
            .find('.modal-body')
            .html('<iframe src="<?= base_url("$ORG/eventos_aperturas/form/") ?>' + row.idx +
...
$("#agregar").on("click", function() {
    ...
    $('#modalForm')
        ...
        .find('.modal-body')
        .html(
            '<iframe src="<?= base_url("$ORG/eventos_aperturas/form/0") ?>" style="border:none" id="info" height="70px" width="100%"></iframe>'
            );
});
