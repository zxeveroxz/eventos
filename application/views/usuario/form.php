    ...
    <div class="container-fluid">
        <div id="principal" class="card fade ">
            ...
            <div class="card-body">
                ...
                <?= form_open(base_url("$ORG/usuarios/save"), ['class' => '', 'id' => 'formy', 'method' => 'POST','onSubmit'=>'return false','autocomplete'=>'off']);
				?>
                ...
                <div class="row">
                    <div class="col-5">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-primary formy" id="usuario"
                ...
                <button type="submit" class="btn btn-md btn-success mr-2 " onclick="emitir()">Guardar</button>
