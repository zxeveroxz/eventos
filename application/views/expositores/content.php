	...
	<div class="row ">
		<div class="col-12">
			<div class="page-header bg-white py-1 px-2 border-bottom border-dark ">
				<h3 class="page-title">EXPOSITORES</h3>
		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-body">
					<table id="table" class="table-striped" data-toggle="table" data-url="<?= base_url("$ORG/expositores/get") ?>" data-height="450">
						<thead>
							<tr>
...
<script>
	...
	window.operateEvents = {
		'click .editar': function(e, value, row, index) {
			...
			$('#modalForm')
				...
				.modal('show')
				.find('.modal-body')
				.html('<iframe src="<?= base_url("$ORG/expositores/form/") ?>' + row.idx + '" style="border:none" id="info" height="70px" width="100%"></iframe>');
		}
	};
	...
	$("#agregar").on("click", function() {
		...
		$('#modalForm')
			...
			.modal('show')
			.find('.modal-body')
			.html('<iframe src="<?= base_url("$ORG/expositores/form/0") ?>" style="border:none" id="info" height="70px" width="100%"></iframe>');
	});
