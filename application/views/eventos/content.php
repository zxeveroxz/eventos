...
<div class="content-wrapper">
	<div class="row ">
		...
		<div class="col-md-12 ">
			<div class="card">
				<div class="card-body">
					<table id="table" class="table-striped" data-toggle="table" data-url="<?= base_url("$ORG/eventos/get") ?>" data-height="450">
						<thead>
							<tr>
								...
								<th data-field="nombre" data-width="100" data-halign="center">NOMBRE</th>
								<th data-field="nombre_largo" data-halign="center">NOMBRE LARGO</th>
...
<script>
	...
	window.operateEvents = {
		'click .editar': function(e, value, row, index) {
			...
			$('#modalForm')
				...
				.modal('show')
				.find('.modal-body')
				.html('<iframe src="<?= base_url("$ORG/eventos/form/") ?>' + row.idx + '" style="border:none" id="info" height="70px" width="100%"></iframe>');
		}
	};
	...
	$("#agregar").on("click", function() {
		...
		$('#modalForm')
			...
			.modal('show')
			.find('.modal-body')
			.html('<iframe src="<?= base_url("$ORG/eventos/form/0") ?>" style="border:none" id="info" height="70px" width="100%"></iframe>');
	});
