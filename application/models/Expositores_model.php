...
class Expositores_model extends CI_Model
{
    public $TABLA = "tbl_expositores";
...
/* End of file Expositores_model.php and path \application\models\Expositores_model.php */
