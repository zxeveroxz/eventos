...
class Eventos_aperturas_model extends CI_Model 
{

    public $TABLA = "tbl_eventos_aperturas";
...
/* End of file Eventos_aperturas_model.php and path \application\models\Eventos_aperturas_model.php */
